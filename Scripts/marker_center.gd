...
func middlebackground_vector():
	if typeof(mouse_position) != TYPE_INT:
		$"../ParallaxAtHome/Logo".position = offset * 0.01
		$"../ParallaxAtHome/DoorFrame".position = offset * -0
		$"../ParallaxAtHome/Doors".position = offset * -0.06
		$"../ParallaxAtHome/Flur".position = offset * -0.19
